...
from experiment import performance
...
def training(batch_rBp_dir, batch_valid_on_shell_dir=None, batch_valid_off_shell_dir=None, dataToken=None,
    ...
    model.log_file = log_dir + "eToT_K%d" % K
    model.checkpoint_file = ckpt_dir + "/eToT_K%d" % K
...
def testing(Model=eToT, hyperparameters=[], resume=None, dataDUE_loader=dataDUELoader,
...
if __name__ == "__main__":
    ...
    for dataset in ["CNN_nolike/","foxnews_nolike/"]:
    # #### period_foxnews_nolike data ####
        ...
        testing(Model=eToT, hyperparameters=[K],resume="ckpt_test/"+dataset+"eToT_K50_best_ppl[4]",
